...
const heroSlides = [
{
  ...
  title: 'Balai Kota Madiun',
  subtitle: 'Pusat Pemerintahan Kota Madiun'
},
{
  src: "/stasiun.jpg",
  title: 'Stasiun Madiun',
  subtitle: 'Pintu Gerbang Kota Madiun'
},
{
  src: "/unnamed.jpg",
  title: 'Taman Wisata Madiun',
  subtitle: 'Destinasi Wisata Keluarga'
},
{
  src: "/unnamed_(1).jpg",
  title: 'Alun-Alun Kota Madiun',
  subtitle: 'Jantung Kota Madiun'
}];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <motion.div
            ...
            <div className="inline-flex items-center gap-2 bg-accent text-dark text-xs md:text-sm font-bold px-4 py-1.5 rounded-full mb-6 shadow-sm">
              <span className="w-2 h-2 rounded-full bg-dark"></span> PORTAL
              RESMI PEMERINTAH
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 w-full max-w-lg">
              <div className="flex flex-col">
                <span className="font-poppins text-3xl md:text-4xl font-black text-accent drop-shadow-sm">
                  <Counter end={201.85} suffix="rb+" />
                </span>
                <span className="text-white text-sm font-medium">penduduk</span>
              </div>
              <div className="flex flex-col">
                <span className="font-poppins text-3xl md:text-4xl font-black text-accent drop-shadow-sm">
                  <Counter end={27} />
